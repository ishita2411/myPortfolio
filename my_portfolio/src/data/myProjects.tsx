export const myProjects = [
...

  {
    ...
    githubLink: "https://github.com/ishita2411/Recipe_video_captioning",
  },
  {
    name: "Predicting Performance of Movie using Sentiment Analysis on YouTube Movie Comments",
    description:
    "Conducted multiple experiments to see if movie trailer comments can be used to predict the performance of a movie. The project involved data collection, preprocessing, and sentiment analysis using various machine learning models. The results showed that these comments alone could predict movie performance with 75% accuracy and the accuracy is much higher when other factors are considered.",
  ...
  {
    name: "Handwritten Digit Recognition and OCR",
    description:
  ...
  },
  {
    ...
    description:
      "Developed a Drowsiness Detection System using OpenCV and Fuzzy Logic to detect and track the movement of a person in a video. If the eye remains closed for more than 2-3 seconds then the person would be detected as drowsy and a loud sound alert is sent.",
    githubLink: null
  },
  {
    name: "Meeting Summarizer",
    description:
      "A web application to upload or record an audio file and get the summarized output of the meeting. It is based on concepts of Natural Language Processing and Speech Recognition. ",
